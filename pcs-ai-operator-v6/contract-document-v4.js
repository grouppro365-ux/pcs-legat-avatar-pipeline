...
(function(root){
  ...
  function definition(d){
    ...
    const leftTable={table:{widths:[76,'*'],body:[row('ชื่อ','Name',d.name),row('เลขบัตร / หนังสือเดินทาง','ID / Passport',d.passport),row('สัญชาติ','Nationality',d.nationality),row('ใบขับขี่','License No.',d.license),row('โทรศัพท์','Phone',d.phone),row('ช่องทางติดต่อ','Contact',d.line),row('ที่อยู่','Address',d.address)]},layout:leftLayout};
