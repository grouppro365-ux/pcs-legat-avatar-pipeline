...
ok(manifest.version==='1.0.1','version 1.0.1');
ok(manifest.background?.service_worker==='service_worker_v101.js','v1.0.1 service worker configured');
ok((manifest.permissions||[]).includes('debugger'),'debugger permission for trusted CDP input');
const files=['service_worker.js','service_worker_v101.js','chat_cdp.js','policy.js','page_agent.js','chatgpt_adapter.js','popup.js'];
...
ok(/AUH_CHAT_CDP/.test(read('service_worker_v101.js')),'dedicated CDP runtime port exists');
